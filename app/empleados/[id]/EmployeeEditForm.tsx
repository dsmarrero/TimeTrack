...
export default function EmployeeEditForm({ employee }: EmployeeEditFormProps) {
  ...
  const [isDeleting] = useTransition();
  ...
  return (
    <form action={formAction} className="flex flex-wrap items-end gap-3">
      ...
      <input type="text" name="name" placeholder="Nombre" defaultValue={employee.name} className={inputClass} required />
      <input type="email" name="email" placeholder="Email" defaultValue={employee.email} className={inputClass} required />
